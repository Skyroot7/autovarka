      ...
      <section className="relative h-[380px] sm:h-[420px] md:h-[500px] lg:h-[600px] overflow-hidden w-full">
        ...
        <div className="absolute inset-0">
          <SafeImage
            ...
            alt="Автомобільна мультиварка 12/24/220V для далекобійника в кабині вантажівки - Автоварка | Від 999₴"
            fill
            priority
            sizes="100vw"
        ...
        <div className="container mx-auto px-4 h-full relative z-10 max-w-full overflow-x-hidden">
          <div className="flex items-center h-full w-full">
            ...
            >
              ...
              >
                <span className="text-sm md:text-sm font-semibold text-white">{t('professionalEquipment')}</span>
              </motion.div>
              ...
              <motion.h1
                ...
                className="text-[26px] sm:text-3xl md:text-5xl lg:text-6xl font-bold mb-2 sm:mb-3 md:mb-4 leading-tight text-white"
              ...
              <motion.p
                ...
                className="text-[17px] sm:text-lg md:text-xl lg:text-2xl mb-2 sm:mb-3 text-white font-light leading-snug"
            ...
            <motion.p
              ...
              className="text-[13px] sm:text-sm md:text-base lg:text-lg mb-2 sm:mb-3 text-white max-w-xl leading-relaxed"
            ...
            <motion.p
              ...
              className="text-[13px] sm:text-sm md:text-base lg:text-lg mb-4 sm:mb-6 md:mb-8 text-orange-200 max-w-xl leading-relaxed font-semibold"
              style={{ textShadow: '1px 1px 4px rgba(0,0,0,0.7)' }}
            >
              🚚 {t('deliveryInfo')}
            </motion.p>
            ...
            >
                <Link
                  ...
                  className="group bg-gradient-to-r from-orange-500 to-orange-600 text-white px-5 sm:px-6 md:px-8 py-3 sm:py-3 md:py-4 rounded-xl font-bold hover:from-orange-600 hover:to-orange-700 transition-all shadow-2xl hover:shadow-orange-500/50 hover:scale-105 inline-flex items-center gap-2 text-sm sm:text-sm md:text-base"
                >
                  {tCommon('products')}
                ...
                <Link
                  ...
                  className="bg-white/10 backdrop-blur-sm border-2 border-white/50 text-white px-5 sm:px-6 md:px-8 py-3 sm:py-3 md:py-4 rounded-xl font-bold hover:bg-white hover:text-orange-600 transition-all shadow-lg hover:scale-105 text-sm sm:text-sm md:text-base"
                >
                  {tCommon('learnMore')}
                </Link>
              </motion.div>
            ...
            {featuredProducts.map((product, index) => (
              ...
              >
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ y: -8 }}
                  className="group bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col border-2 border-gray-100 hover:border-orange-200 h-full cursor-pointer"
                >
                  <div 
                  ...
                  >
                    <SafeImage
                      ...
                      alt={`${product.name} - автомобільна мультиварка ${product.specifications.voltage || ''} ${product.specifications.capacity || ''} для далекобійника | ${product.price}₴`}
                      fill
                  ...
                  <div className="p-6 md:p-8 flex flex-col flex-1">
                    ...
                    <div className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white text-center py-4 rounded-2xl font-bold group-hover:from-orange-600 group-hover:to-orange-700 transition-all shadow-lg group-hover:shadow-xl transform group-hover:scale-105 flex items-center justify-center gap-2">
                      {tCommon('viewDetails')}
