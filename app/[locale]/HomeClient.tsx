                ...
                >
                  ...
                  >
                    <SafeImage
                      ...
                      alt={`${locale === 'en' ? product.nameEn : locale === 'ru' ? product.nameRu : locale === 'pl' ? product.namePl : locale === 'de' ? product.nameDe : product.name} ${product.specifications.voltage || ''} ${product.specifications.capacity || ''} | ${product.price}₴`}
                      fill
