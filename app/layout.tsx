...
export const metadata: Metadata = {
  ...
  title: {
    default: "Автоварка – мультиварки 12/24/220В для далекобійника | від 999₴",
    template: "%s | Автоварка - Мультиварки для Далекобійників",
  },
  description: "🚗 Автомобільні мультиварки 12В, 24 вольта, 220В для далекобійників і вантажівок. ✅ Гарантія 6 місяців ⚡ Швидка доставка по Україні від 999₴. Купити мультиварку для фури зараз!",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Автомобільні мультиварки 24 вольта для вантажівок і далекобійників. Гарантія 6 місяців. Швидка доставка по Україні. Купити мультиварку для фури!",
    type: "website",
    locale: "uk_UA",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Автомобільна мультиварка 12/24/220V для далекобійника - Автоварка',
      },
    ],
  },
  twitter: {
    ...
    description: "Автомобільні мультиварки для вантажівок. Гарантія 6 місяців. Доставка по Україні. Купити мультиварку 12/24/220 для далекобійника!",
