...
export const metadata: Metadata = {
  ...
  title: {
    default: "⚡ Автоварка - Мультиварка 12/24/220V для Вантажівки | від 999₴ | Доставка по Україні",
  ...
  openGraph: {
    title: "⚡ Автоварка - Мультиварка 12/24/220V для Дальнобійщиків | від 999₴",
    description: "🚗 Автомобільні мультиварки 24 вольта для вантажівок і дальнобійщиків. ✅ Гарантія 6 місяців ⚡ Швидка доставка по Україні. Купити мультиварку 12/24/220 для фури!",
    type: "website",
    locale: "uk_UA",
  ...
  twitter: {
    ...
    title: "⚡ Автоварка - Мультиварка 24 вольта для Дальнобійщиків | від 999₴",
    description: "🚗 Автомобільні мультиварки для вантажівок. ✅ Гарантія ⚡ Доставка по Україні. Купити мультиварку 12/24/220 для дальнобійщика!",
